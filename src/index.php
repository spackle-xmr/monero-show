...
$daemonRPC = new daemonRPC('172.17.0.1', 18089, false); // Change to match your daemon (monerod) IP address and port; 18081 is the default port for mainnet, 28081 for testnet, 38081 for stagenet
...
$on_getblockhash = $daemonRPC->on_getblockhash(425);
...
$walletRPC = new walletRPC('172.17.0.1', 18083, false); // Change to match your wallet (monero-wallet-rpc) IP address and port; 18083 is the customary port for mainnet, 28083 for testnet, 38083 for stagenet
